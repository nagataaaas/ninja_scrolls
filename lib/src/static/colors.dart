...
class Common {
  ...
  static const darkPeach = Color(0xFFE85A7F);
  ...
  static const dusk = Color.fromARGB(255, 61, 43, 16);
  static const mintGreen = Color(0xFF13C39C);
  static const limeGreen = Color(0xFF6ED25E);
  static const milk = Color.fromARGB(255, 250, 245, 240);
  static const dustMilk = Color.fromARGB(255, 241, 233, 225);
  static const geekGreen = Color.fromARGB(255, 11, 189, 11);
}
